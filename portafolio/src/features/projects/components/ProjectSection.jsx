            ...
            <div className="max-w-7xl mx-auto space-y-16">
                <header className="space-y-4 max-w-2xl">
                    ...
                    <p className="text-text-secondary text-lg">
                        Proyecto desarrollado para una tienda tecnológica real, enfocado en la
                        creación de una plataforma web moderna para mostrar servicios,
                        mejorar la presencia digital del negocio y ofrecer una experiencia
